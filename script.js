...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const saveInvoiceButton = document.getElementById('saveInvoiceButton'); // Get the Save Invoice button
    ...
    function previewInvoice() {
        ...
        document.getElementById('previewSellerEmail').textContent = "// script.js (version00006)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function previewInvoice() {
        ...
        saveInvoiceButton.style.display = 'block'; // Make the Save Invoice button visible
    }
